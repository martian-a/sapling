...
<p:declare-step xmlns:p="http://www.w3.org/ns/xproc"
	...
	<p:store serialization="map{'method' : 'html', 'version' : '5', 'encoding' : 'utf-8', 'indent' : 'true', 'media-type' : 'text/html'}">
		<p:with-option name="href" select="concat($dataset-name, '/people_by_location.html')" />
	</p:store>        
	...
	<p:store serialization="map{'method' : 'html', 'version' : '5', 'encoding' : 'utf-8', 'indent' : 'true', 'media-type' : 'text/html'}">
		<p:with-option name="href" select="concat($dataset-name, '/people_by_name.html')" />
	</p:store>
	...
	<p:store serialization="map{'method' : 'html', 'version' : '5', 'encoding' : 'utf-8', 'indent' : 'true', 'media-type' : 'text/html'}">
		<p:with-option name="href" select="concat($dataset-name, '/people_by_time.html')" />
	</p:store>
	...
	<p:store serialization="map{'method' : 'html', 'version' : '5', 'encoding' : 'utf-8', 'indent' : 'true', 'media-type' : 'text/html'}">
		<p:with-option name="href" select="concat($dataset-name, '/locations_by_event.html')" />
	</p:store>
