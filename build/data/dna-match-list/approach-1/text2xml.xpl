...
<p:declare-step xmlns:p="http://www.w3.org/ns/xproc"
    ...
    <p:input port="source" primary="true" content-types="text/plain">
    	<p:document href="../../../../../fortunes-olive-data/import/dna-analysis/data/I432064074593.20220803.dna-match-list.tsv" content-type="text/plain" />
    </p:input>
    ...
    <p:xslt>
        <p:with-input port="stylesheet">
            <p:document href="create/columns.xsl" />
        </p:with-input>
    </p:xslt>    
