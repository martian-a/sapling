...
declare
	...
	(: Valid id :)
	%test:args('PER2')
	%test:assertXPath("$result[count(person) = 4]")
	%test:assertXPath("$result/person[@id = 'PER1']")
	%test:assertXPath("$result/person[@id = 'PER4']")
	%test:assertXPath("$result/person[@id = 'PER5']")
	%test:assertXPath("$result/person[@id = 'PER6']")
