...
declare variable $config:app-test-dir := "sapling-test";
declare variable $config:upload-path-to-test-data := concat("/db/apps/", $config:app-test-dir, "/data/");
declare variable $config:upload-path-to-test-modules := concat("/db/apps/", $config:app-test-dir, "/modules/");

declare variable $config:path-to-view := concat("/exist/apps/", $config:app-test-dir, "/view/");
...
declare variable $config:db := collection($config:upload-path-to-test-data);