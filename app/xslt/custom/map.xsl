...
<xsl:stylesheet 
    ...
    <xsl:template match="/app[view/data/entities/location or view/data/location or view/data/person or view/data/source or view/data/organisation]" mode="html.header.style" priority="650">
    ...
    <xsl:template match="/app[view/data/entities/location or view/data/location or view/data/person or view/data/source or view/data/organisation]" mode="html.header.scripts" priority="650">
    ...
    <xsl:template match="/app[view/data[entities/location/geo:point or location/geo:point or person/related/location/geo:point or source/related/location/geo:point or organisation/related/location/geo:point]]" mode="html.footer.scripts" priority="650">
        <xsl:next-match />
    ...
    <xsl:template match="data[entities/location/geo:point or location/geo:point or person/related/location/geo:point or source/related/location/geo:point or organisation/related/location/geo:point] | data/person/related[location] | data/source/related[location] | data/organisation/related[location]" mode="map locations html.footer.scripts" priority="650">
    ...
    <xsl:template match="view[data[entities/location/geo:point or location/geo:point or person/related/location/geo:point or source/related/location/geo:point or organisation/related/location/geo:point]]" mode="html.footer.scripts" priority="600">
