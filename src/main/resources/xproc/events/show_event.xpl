...
<p:declare-step xmlns:p="http://www.w3.org/ns/xproc" xmlns:c="http://www.w3.org/ns/xproc-step" xmlns:k="http://schema.kaikoda.com/ns/xproc" type="k:show-event" name="show-event" version="1.0">
	
	<p:input port="source" sequence="false" primary="true" select="/sapling/event"  />
	...
	<p:xslt version="1.0" name="transform">					
		...
		<p:input port="source">
			<p:pipe step="show-event" port="source" />
		</p:input>			
					
		<p:input port="stylesheet">
			<p:document href="../../xslt/events/show_event.xsl"/>
